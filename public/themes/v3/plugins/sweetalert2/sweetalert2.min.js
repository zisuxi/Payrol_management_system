! function(e, t) {
	...
	const X = {
		...
		xe = (e, t) => {
			var n, o, i, a, r, s = U(),
				c = R();
			(t.showConfirmButton || t.showDenyButton || t.showCancelButton ? d : h)(s), Q(s, t, "actions"), s = s, n = c, o = t, i = V(), a = N(), r = F(), Ee(i, "confirm", o), Ee(a, "deny", o), Ee(r, "cancel", o),
				function(e, t, n, o) {
	...
	const Se = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
		...
		Ie = {},
		He = (Ie.text = Ie.email = Ie.password = Ie.number = Ie.tel = Ie.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : A(t.inputValue) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')), Me(e, e, t), je(e, t), e.type = t.input, e), Ie.file = (e, t) => (Me(e, e, t), je(e, t), e), Ie.range = (e, t) => {
	...
	const Rt = (e, t, n) => {
		...
		Wt = (e, n, o) => {
			...
			if (i)
				if (i.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key) e = e, a = n, t = i, w(t.allowEnterKey) && !a.isComposing && a.target && e.getInput() && a.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(t.input) || (Nt(), a.preventDefault()));
				else if ("Tab" !== n.key) {
	...
	e = Object.freeze({
		...
		argsToParams: n => {
			const o = {};
			return "object" != typeof n[0] || _t(n[0]) ? ["title", "html", "icon"].forEach((e, t) => {
				t = n[t];
	...
	function Qt(e, t, n, o) {
		Z() ? on(e, o) : (he(n).then(() => on(e, o)), f.keydownTarget.removeEventListener("keydown", f.keydownHandler, {
	...
	const pn = (l, u, d) => new Promise((e, t) => {
			...
			var o, i, a;
			Gt.swalPromiseResolve.set(l, e), Gt.swalPromiseReject.set(l, t), u.confirmButton.onclick = () => {
				var e = l,
			...
			}, u.closeButton.onclick = () => n(Ge.close), e = l, t = u, a = n, b.innerParams.get(e).toast ? Dt(e, t, a) : (Ht(t), qt(t), Vt(e, t, a)), o = l, e = f, t = d, i = n, e.keydownTarget && e.keydownHandlerAdded && (e.keydownTarget.removeEventListener("keydown", e.keydownHandler, {
				capture: e.keydownListenerCapture
			}), e.keydownHandlerAdded = !1), t.toast || (e.keydownHandler = e => Wt(o, e, i), e.keydownTarget = t.keydownListenerCapture ? window : g(), e.keydownListenerCapture = t.keydownListenerCapture, e.keydownTarget.addEventListener("keydown", e.keydownHandler, {
				capture: e.keydownListenerCapture
		...
		vn = (Object.assign(dn.prototype, ln), Object.assign(dn, e), Object.keys(ln).forEach(e => {
			dn[e] = function() {
